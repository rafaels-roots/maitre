				...
				$("#grupos").on("pageshow", function() 
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/admin/gru_processa.php?callback=?', {action: "f_select",banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"]}, function(data)
							{ 	
						...
						$("#list_Grupos").on( "click", "li", function() 
							{
								var json_gru = JSON.parse(f_storageready("json_gru"));
