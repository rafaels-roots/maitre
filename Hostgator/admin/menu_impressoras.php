			...
			<script>
				...
				$("#menu_impressoras").on("pageshow", function() 
					{ 
						...
						//var json_imp = 
						$.getJSON('http://www.sisleq.com.br/maitre/admin/imp_processa.php?callback=?', {action: "f_select_imprel", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"]}, function(data)
							{
								f_storagewrite("json_imprel" , JSON.stringify(data) );
								//json_imp = data;
								f_listviewinsert(data , "imp_codigo", "imp_local", "#list_MenuImpressoras", "#"); 
						...
						$("#list_MenuImpressoras").on("click", "li",  function()
							{
								...
								var json_imp = JSON.parse(f_storageready("json_imprel"));
