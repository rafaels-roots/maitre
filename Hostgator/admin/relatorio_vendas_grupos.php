				...
				$("#relatorio_vendas_grupos").on("pageshow", function() 
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/admin/gru_processa.php?callback=?', {action: "f_select_rel_gru",	banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"]}, function(data)
							{
								var select_grupos = "";
							...
							{		
								if( $(this).attr('id') == "Visualizar" )
									{	
										...
										$.getJSON('http://www.sisleq.com.br/maitre/admin/gru_processa.php?callback=?', {action: "f_print_rel_gru",banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"] , par1: wfield, par2:wwhere, par3:gropy, par4:orderby }, function(data)
											{
												if( data.length == 0  ) 
													{												
												...
												else 
													{
														...
														$.getJSON('http://www.sisleq.com.br/maitre/admin/gru_processa.php?callback=?', {action:"f_datahora"}, function(data)
															{
