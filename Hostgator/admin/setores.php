				...
				$("#setores").on("pageshow", function() 
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/admin/sto_processa.php?callback=?', {action: "f_select",	banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"]}, function(data)
							{ 
