				...
				$("#usuarios").on("pageshow", function() 
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/admin/usu_processa.php?callback=?', {action: "f_select",	banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"]}, function(data)
							{
						...
						$("#list_Usuarios").on( "click", "li", function() 
							{
								var json_usu = JSON.parse(f_storageready("json_crudusu"));
