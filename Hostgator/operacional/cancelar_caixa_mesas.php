				...
				$("#cancelar_caixa_mesas").on("pageshow", function()
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?', {action : "f_select", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"], sql : "cancelar_mesas_caixa" }, function(data) 
							{
								if( data.length == 0 )
									{  
