			...
			<script>
				$("#comandar_itens").on("pageshow", function()
					{					
						...
						$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?',{action : "f_select", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"], sql : "comandar_mesas_itens", par1 : f_storageready("mes_codigo") }, function(data) 
							{
								if(data.length == 0) 
									{
												...
												if($(this).is(":checked") == true) 
													{
														...
														wpro_array[i]["mov_comanda"] = "S"
													}
													
											});
										
										$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?', {action: "f_datahora"}, function(data) 
											{
