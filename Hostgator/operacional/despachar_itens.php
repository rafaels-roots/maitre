				...
				$("#despachar_itens").on("pageshow", function()
					{
						...
						$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?', {action : "f_select", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"], sql : "despachar_mesas_itens", par1 : f_storageready("mes_codigo") }, function(data) 
							{
						...
						$("#despachar_itens #menuopcoes").on("click", "li", function()	 
							{
								...
								if($(this).attr("id") == "Gravar") 
									{	
										...
										$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?', {action: "f_despacharpedidos", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"], sql: wsql }, function(data) 
											{
