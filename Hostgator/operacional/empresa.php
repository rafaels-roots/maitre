				...
				$("#empresa").on("pageshow", function(e, ui) 
					{	
						...
						$(".emp_submit").click(function()
							{
								$.mobile.loading("show");										
								$.getJSON('http://www.sisleq.com.br/maitre/operacional/processa_operacional.php?callback=?', {action: "f_select", banco: "sisle873_maitre_empresas", sql: "empresa", par1: JSON.parse(f_storageready("json_ter"))[0]["emp_codigo"] }, function(data)
									{
										if( data.length == 0  )
											{  
