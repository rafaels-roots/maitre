        ...
        <div data-role="page" id="index">  
            ...
            <div data-role="main" class="ui-content">
                ...
                <form method="post">   
                    ...
                    <input type="text" name="mac_ter" id="mac_ter" />
                    
                    <input type="button" class="mac_submit" value="Validar" style="text-shadow:none;margin-top:10px;">	  
                </form>
            </div>
				...
				$("#index").on("pageshow", function() 
					{ 	
						...
						$(".mac_submit").click(function()
							{
								$.mobile.loading("show");																				
								var dados = {action: "f_select", banco: "sisle873_maitre_terminal", sql : "terminal", par1 :  ElementsAspa($("#mac_ter").val()) };
								$.getJSON('http://192.168.0.7/maitre/processa_admin.php?callback=?', dados, function(data)
									{
