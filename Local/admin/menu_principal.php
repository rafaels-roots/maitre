			...
			$("#menu_principal").on("pageshow", function() 	
				{ 			
					...
					$("#rel_pro").on("click", function()		
						{																			
							$.mobile.loading("show");										
							var json_dados = {action: "f_select",banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"] ,sql: "print_pro" };
										
							$.getJSON('http://192.168.0.7/maitre/processa_admin.php?callback=?', json_dados, function(data)
								{
