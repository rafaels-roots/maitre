				...
				$("#ocupacao").on("pageshow", function() 
					{
						...
						var json_ocu = {action: "f_select",banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"] ,sql: "ocupacao"}; 
						$.getJSON('http://192.168.0.7/maitre/processa_admin.php?callback=?', json_ocu, function(data)
							{
