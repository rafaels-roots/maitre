				...
				$("#relatorio_vendas_mesas").on("pageshow", function() 
					{
						...
						var json_select = {action: "f_select",	banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"] , sql: "select_rel_mes"};
							...
							{		
								if( $(this).attr('id') == "Visualizar" )
									{	
										...
										var rel_opcoes = {action: "f_select",banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"] ,sql: "print_rel_mes", par1: wfield, par2: wwhere, par3: gropy, par4:orderby };
