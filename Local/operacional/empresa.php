        ...
        <div data-role="page" id="empresa">  
            ...
            <div data-role="main" class="ui-content">
                ...
                <form method="post">   
                    ...
                    <input type="text" name="emp_ter" id="emp_ter" disabled />
			...
			<script>
				...
				$("#empresa").on("pageshow", function(e, ui) 
					{	
						...
						$(".emp_submit").click(function()
							{
								$.mobile.loading("show");										
								$.getJSON('http://192.168.0.7/maitre/processa_operacional.php?callback=?', {action: "f_select", banco: "sisle873_maitre_empresas", sql: "empresa", par1: ElementsAspa(JSON.parse(f_storageready("json_ter"))[0]["emp_codigo"]) }, function(data)
									{
