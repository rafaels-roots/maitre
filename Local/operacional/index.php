					...
					$("#index").on("pageshow", function() 
						{ 	
							...
							$("#mac_submit").click(function()
								{
									$.mobile.loading("show");																				
									$.getJSON('http://192.168.0.7/maitre/processa_operacional.php?callback=?', {action: "f_select", banco: "sisle873_maitre_terminal", sql : "terminal", par1 :  ElementsAspa($("#mac_ter").val()) }, function(data)
										{
