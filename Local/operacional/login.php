						...
						$(".usu_submit").click(function() 
							{
								...
								$.getJSON('http://192.168.0.7/maitre/processa_operacional.php?callback=?', {action: "f_select", banco : JSON.parse(f_storageready("json_ter"))[0]["emp_banco"], sql: "login", par1 : ElementsAspa( $("#usu_nome").val()  ), par2: ElementsAspa( $("#usu_senha").val()  )  }, function(data)
									{
